...
ms.locfileid: "906330"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="94c67-103">Dzīves cikla datu eksports</span><span class="sxs-lookup"><span data-stu-id="94c67-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="94c67-104">Šī lapa ir izstrādes stadijā.</span><span class="sxs-lookup"><span data-stu-id="94c67-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="94c67-105">Visu produktu eksportēšana</span><span class="sxs-lookup"><span data-stu-id="94c67-105">Export all products</span></span>
<span data-ttu-id="94c67-106">Eksportējiet datu dzīves cikla datus visiem produktiem, noklikšķinot uz Tālāk.</span><span class="sxs-lookup"><span data-stu-id="94c67-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="94c67-107">Visu produktu eksportēšana</span><span class="sxs-lookup"><span data-stu-id="94c67-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="94c67-108">Produktu eksportēšana no ģimenes un grupas</span><span class="sxs-lookup"><span data-stu-id="94c67-108">Export products by Family and Group</span></span>
<span data-ttu-id="94c67-109">Atlasiet ģimeni un pēc tam grupu, kuru vēlaties eksportēt.</span><span class="sxs-lookup"><span data-stu-id="94c67-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="94c67-110">Piezīme. eksportēšana sāksies, ja būs atlasīta grupas vērtība.</span><span class="sxs-lookup"><span data-stu-id="94c67-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="94c67-171">Produktu eksportēšana pēc atbalsta datuma beigām</span><span class="sxs-lookup"><span data-stu-id="94c67-171">Export products by end of support date</span></span>
<span data-ttu-id="94c67-172">Atlasiet gadu, lai redzētu produktus, kas sasniedz atbalsta beigas.</span><span class="sxs-lookup"><span data-stu-id="94c67-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="94c67-173">Piezīme. eksportēšana sāksies, kad ir atlasīta gada vērtība.</span><span class="sxs-lookup"><span data-stu-id="94c67-173">Note: Export will begin when Year value is selected.</span></span>
