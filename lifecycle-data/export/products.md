...
ms.locfileid: "885192"
---
# <a name="export"></a><span data-ttu-id="eb051-103">Eksportēšana</span><span class="sxs-lookup"><span data-stu-id="eb051-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="eb051-104">Šī lapa ir izstrādes stadijā.</span><span class="sxs-lookup"><span data-stu-id="eb051-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="eb051-105">Visu produktu eksportēšana</span><span class="sxs-lookup"><span data-stu-id="eb051-105">Export All Products</span></span>
<span data-ttu-id="eb051-106">Eksportējiet visus produktus bez filtriem.</span><span class="sxs-lookup"><span data-stu-id="eb051-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="eb051-107">Visu produktu eksportēšana</span><span class="sxs-lookup"><span data-stu-id="eb051-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="eb051-108">Produktu eksportēšana pēc kategorijas</span><span class="sxs-lookup"><span data-stu-id="eb051-108">Export Products by Category</span></span>
<span data-ttu-id="eb051-109">Atlasiet eksportējamo grupu:</span><span class="sxs-lookup"><span data-stu-id="eb051-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="eb051-167">Produktu eksportēšana pēc atbalsta gada beigām</span><span class="sxs-lookup"><span data-stu-id="eb051-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="eb051-168">Atlasiet gadu, lai eksportētu produktu beigu pakalpojumu attiecīgajā gadā:</span><span class="sxs-lookup"><span data-stu-id="eb051-168">Select a year to export products ending service in that year:</span></span>
